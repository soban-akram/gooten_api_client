...
module GootenApiClient
  class ProductVariantResponse
    ...
    def self.swagger_types
      {
        ...
        :'options' => :'Array<ProductOptionList>'
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'ProductVariants']
        if (value = attributes[:'ProductVariants']).is_a?(Array)
          self.product_variants = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          product_variants == o.product_variants &&
          options == o.options
    end
