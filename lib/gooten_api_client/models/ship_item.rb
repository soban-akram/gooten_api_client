...
module GootenApiClient
  class ShipItem
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'ShipOptions']
        if (value = attributes[:'ShipOptions']).is_a?(Array)
          self.ship_options = value
        end
      end
