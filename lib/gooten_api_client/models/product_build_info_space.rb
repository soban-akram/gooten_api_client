...
module GootenApiClient
  class ProductBuildInfoSpace
    ...
    attr_accessor :default_rotation
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'DefaultRotation']
        self.default_rotation = attributes[:'DefaultRotation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          index == o.index &&
          default_rotation == o.default_rotation &&
          layers == o.layers
    end
    ...
    def hash
      [id, description, index, default_rotation, layers].hash
    end
