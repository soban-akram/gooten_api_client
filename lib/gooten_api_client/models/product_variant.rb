...
module GootenApiClient
  class ProductVariant
    ...
    attr_accessor :max_images

    attr_accessor :has_templates
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'MaxImages']
        self.max_images = attributes[:'MaxImages']
      end
      
      if attributes[:'HasTemplates']
        self.has_templates = attributes[:'HasTemplates']
      end
    ...
    def hash
      [sku, max_images, has_templates, options, price_info, partner_price_info].hash
    end
