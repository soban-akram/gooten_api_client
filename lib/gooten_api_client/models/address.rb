...
module GootenApiClient
  class Address
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'StateOrProvinceCode']
        self.state_or_province_code = attributes[:'StateOrProvinceCode']
      end
      
      if attributes[:'StreetLines']
        if (value = attributes[:'StreetLines']).is_a?(Array)
          self.street_lines = value
        end
      end
    ...
    def hash
      [city, country_code, postal_code, state_or_province_code, street_lines].hash
    end
