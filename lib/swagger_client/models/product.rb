...
module SwaggerClient
  class Product
    ...
    def hash
      [id, u_id, name, short_description, has_available_product_variants, has_product_templates, featured_index, max_zoom, retail_price, info, product_image, price_info, categories].hash
    end
