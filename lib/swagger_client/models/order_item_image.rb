...
module SwaggerClient
  class OrderItemImage
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'ManipCommand']
        self.manip_command = attributes[:'ManipCommand']
      end
    ...
    def hash
      [url, index, thumbnail_url, manip_command, space_id].hash
    end
