...
module SwaggerClient
  class OrderstatusApi
    ...
    def p_ost_orderstatus(id, order_status_name, opts = {})
      data, status_code, headers = p_ost_orderstatus_with_http_info(id, order_status_name, opts)
      return data
    end
    ...
    def p_ost_orderstatus_with_http_info(id, order_status_name, opts = {})
